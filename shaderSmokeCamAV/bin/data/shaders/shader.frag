...
//
    if(texture(tex0, varyingtexcoord) != vec4(1.0,1.,1., 1.0)){
...
//        dispTexCo.x += u_resolution.x * mx;
//        dispTexCo.y+=u_resolution.y * my;
...
//    else{
//    dispTexCoV.x += u_resolution.x ;
//    dispTexCoV.y+= u_resolution.y  ;
//    dispTexCo.x += u_resolution.x ;
//            dispTexCo.y+= rand(st)*u_resolution.y ;
//            
//        }
//    
...
//
      ...
      colB.r = texture(tex0, vec2(dispTexCo.x - my, dispTexCo.y + mx)).g;
...
//    col = vec4(vec3(1.0-g), 1.0);
//    col = vec4(palette(1.0-g, vec3(0.5,0.5,0.5), vec3(0.5,0.5,0.5), vec3(1.0, 0.7, 0.4),vec3(0.0,0.15,0.2)),1.0);
...
//
//    if(g > 0.9)
//        col = vec4(vec3(1.0-(0.4 * g)), 1.0);
//    else
//        col  = vec4(vec3(0.04), 1.0);
////
