...
//   f.drawString(s, ofGetWidth()/3, ofGetHeight()/2);
  
    f.drawString(s, ofGetWidth()/4 - r.width/2, fmod(ofGetHeight()/2-mv, ofGetHeight() + r.height));
    s = "B";
    r = f.getStringBoundingBox(s, 0, 0);
    f.drawString(s, 3*ofGetWidth()/4 - r.width/2, fmod(ofGetHeight()-mv, ofGetHeight() + r.height));
  shader.begin();
...
//     shader.setUniform3f("a", abs(cos(t)*0.5) + 0.5,abs(sin(t)*0.5), abs(sin(t)) );
    ...
    s = "O";
      r = f.getStringBoundingBox(s, 0, 0);
    f.drawString(s, ofGetWidth()/4 - r.width/2, fmod(ofGetHeight()-mv, ofGetHeight() + r.height));
   
    s = "L";
      r = f.getStringBoundingBox(s, 0, 0);
    f.drawString(s, 3*ofGetWidth()/4 - r.width/2, fmod(ofGetHeight()/2-mv, ofGetHeight() + r.height));
